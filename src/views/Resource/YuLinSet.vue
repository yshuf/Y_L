  ...
  data() {
    return {
      ...
      list: [
        ...
        { label: "二氧化碳浓度", name: "max_atm_co2", src: "smoke.jpg" },
        {label: "烟雾浓度",name:'max_atm_smoke', src: "smoke.jpg"},
        {
          label: "土壤温度",
          name: "max_soil_tem",
          src: "stem.jpg"
        ...
        { label: "土壤盐分", name: "max_soil_nity", src: "nity.jpg" },
        { label: "土壤电导率", name: "max_soil_conduct", src: "conduct.jpg" },
        { label: "水温", name: "max_water_tem", src: "wtem.jpg" },
        { label: "浑浊度", name: "max_water_tur", src: "tur.png" }
      ]
    };
  },
  methods: {
